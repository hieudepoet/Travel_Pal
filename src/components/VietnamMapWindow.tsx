        ...
        return (
            <div className="map-pane map-pane--main relative w-1/3 h-full flex justify-center items-center overflow-hidden">
                {showRoute && customRoute ? (
                    ...
                    <>
                        <svg viewBox={vietnamViewBox} className="w-full h-auto max-h-full" style={{ filter: 'drop-shadow(0 0 10px rgba(0,0,0,0.3))' }}>
        ...
        return (
            <div className="map-pane map-pane--main relative w-1/3 h-full flex justify-center items-center overflow-hidden">
                ...
                {showRoute && customRoute ? (
                    ...
                    <>
                        <svg viewBox={regionDef.viewBox} className="w-full h-auto max-h-full">
